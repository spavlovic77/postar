...
export default function DashboardInvitationsPage() {
  ...
  const [scopeFilter, setScopeFilter] = useState("own") // own or all
  ...
  const fetchInvitations = useCallback(async () => {
    ...
    if (scopeFilter !== "own") params.set("scope", scopeFilter)
    ...
    <div className="flex flex-col gap-6 p-6">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <Select value={scopeFilter} onValueChange={setScopeFilter}>
              ...
              <SelectContent>
                <SelectItem value="own">Moje pozvanky</SelectItem>
                <SelectItem value="all">Vsetky (moje spolocnosti)</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="flex items-center gap-2">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={scopeFilter === "own" 
            ? "Zatial ste neodoslali ziadne pozvanky." 
            : "Zatial neboli odoslane ziadne pozvanky pre vase spolocnosti."
          }
        />
      )}
